...
* <ins>Task 1. Create prompts</ins>
    ...
    * ![](img/10/25.lab_overview_create_prompt.jpg)
    ...
    6. <ins>FREE-FORM mode</ins> - try zero-shot prompting
        1. the prompt input field: What is a prompt gallery? -> SUBMIT -> The model will respond to a comprehensive definition of the term prompt gallery.
        2. Here are some exploratory exercises to explore. 
            1. adjust the Token limit parameter to 1 -> SUBMIT. 
            2. Token limit : 1024
            3. Temperature : 0.5
            4. Temperature : 1.0
        3. Inspect if how the responses change as to change the parameters?

    7. <ins>STRUCTURED mode</ins> - design prompts in more organized ways. You can also provide Context and Examples in their respective input fields. This is a good opportunity to learn one-shot and few-shot prompting.
        1. In this section, you will ask the model to complete a sentence. 
        2. Create Prompt window > STRUCTURED tab > Test field > INPUT field : the color of the sky is > SUBMIT.
        ...
        * [](img/10/28.lab_structured_example.jpg)
        5. Under Examples field > INPUT field : the color of the grass is > OUTPUT field > green > SUBMIT > Now the model will respond to complete the sentence instead. The response should be something like this. You have successfully influenced the way the model produces response.

    8. use the model to perform sentiment analysis on a sentence, such as determining whether a movie review is positive or negative.
...
*<ins>Task 2. Create conversations</ins>
    * ![](img/10/32.conversation.jpg)
    1. Create Chat Prompt lets you have a freeform chat with the model, which tracks what was previously said and responds based on context.
    * ![](img/10/33.chat_prompt,jpg)
    2. Language page > CREATE CHAT PROMPT > the new chat prompt page.
    3. For this section, you will add context to the chat and let the model respond based on the context provided.
    4. Context field : Your name is Roy. You are a support technician of an IT department. You only respond with "Have you tried turning it off and on again?" to any queries.
    5. the chatbox under Responses : My computer is so slow
    6. Send message > The model would consider the provided additional context and answer the questions within the constraints.
    * ![](img/10/34.explore.jpg)
    
* <ins>Task 3. Explore prompt gallery</ins>
    1. Prompt Gallery lets you explore how generative AI models can work for a variety of use cases.
    * ![](img/10/35.gallery.jpg)
    * 2. Language > find Prompt Gallery > Pick any two use cases from Summarization, Classification, Extraction, Writing, and Ideation, and explore them at your own pace.
